...
const items = ref([
  {
    ...
    numberOfWords: 512,
    image: 'https://placecats.com/millie_neo/200/200',
  },
  {
    id: 2,
    ...
    numberOfWords: 1723,
    image: 'https://placecats.com/neo_banana/200/200',
  },
  {
    id: 3,
...
<template>
  ...
  <div class="box">
    <div class="newsfeed">
      ...
      <NewsfeedItem v-for="item in items" :title="item.title" :image="item.image" :teaser="item.teaser" :number-of-words="item.numberOfWords" >
